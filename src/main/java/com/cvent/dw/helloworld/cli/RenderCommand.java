package com.cvent.dw.helloworld.cli;

import com.cvent.dw.helloworld.CventConferenceTestDropwizardConfiguration;
...
public class RenderCommand extends ConfiguredCommand<CventConferenceTestDropwizardConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<CventConferenceTestDropwizardConfiguration> bootstrap,
                       Namespace namespace,
                       CventConferenceTestDropwizardConfiguration configuration) throws Exception {
